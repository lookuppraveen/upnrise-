// PlatformCopilot — client UI for the super-admin AI drawer.
// Mirrors AdminCopilot in structure but POSTs to /api/super/copilot/chat.
...
const QUICK_PROMPTS = [
  "Who's at the highest churn risk this week?",
  "How does our plan mix look?",
  "Draft a CSM outreach for the most at-risk account",
  "What's been happening across tenants?",
];
...
export function PlatformCopilot() {
  ...
  async function send(text: string) {
    ...
    try {
      const res = await fetch("/api/super/copilot/chat", {
        method: "POST",
        ...
        {messages.length === 0 ? (
          <div className="space-y-3">
            <div className="bg-ai-grad-soft rounded-md p-3 text-[12.5px] text-ink">
              I see every tenant. Ask about at-risk accounts, MRR forecasts,
              plan mix, or recent activity — I'll pull real data and draft
              concrete moves.
            </div>
